grep -q 'Amlogic Meson GXL (S905L2) X7 5G Tv Box$' /proc/device-tree/model
if [ "$?" = "0" ]; then
  # amlogic s905l2 tv box
  ...
  echo "SYSTEM_MODEL_DETAILED=amlogic_s905_l2_tv_box" >> /data/config/info.txt
