...
if [ "$#" != "2" ]; then
  ...
  for i in $(ls ${IMAGEBUILDER}/systems | grep -E 'allwinner_h6|amlogic_gx|amlogic_m8|odroid_mc1|odroid_u3|raspberry_pi_3|raspberry_pi_4|rockchip_rk33xx|rockchip_rk3288'); do
